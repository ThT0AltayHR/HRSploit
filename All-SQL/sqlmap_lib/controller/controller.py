...
def start():
    ...
    for targetUrl, targetMethod, targetData, targetCookie, targetHeaders in kb.targets:
        ...
        try:
            ...
            conf.httpHeaders = [conf.httpHeaders[i] for i in range(len(conf.httpHeaders)) if conf.httpHeaders[i][0].upper() not in (__[0].upper() for __ in conf.httpHeaders[i + 1:])]
