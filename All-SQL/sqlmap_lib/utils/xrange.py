...
class range(object):
    ...
    True
    >>> list(range(8, 0, -16)) == list(range(8, 0, -16))
    True
    >>> list(range(0, 8, 16)) == list(range(0, 8, 16))
    True
    >>> list(range(0, 4, 5)) == list(range(0, 4, 5))
    True
    >>> list(range(4, 0, 3)) == list(range(4, 0, 3))
    True
    >>> list(range(0, -3)) == list(range(0, -3))
    True
    >>> list(range(0, 7, 2)) == list(range(0, 7, 2))
    True
    >>> list(range(8, 0, -2)) == list(range(8, 0, -2))
    True
    >>> foobar = range(1, 10)
    >>> 7 in foobar
    True
