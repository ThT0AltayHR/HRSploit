...
def bisection(payload, expression, length=None, charsetType=None, firstChar=None, lastChar=None, dump=False):
    ...
    try:
        ...
        def huffmanChar(idx):
            ...
            heap = []
            for order, ordinal in enumerate(range(128)):
                    ...
                    if len(charTbl) == 1:
                        ...
                        # Going beyond the original charset
                            ...
                            if expand and shiftTable:
                                ...
                                charTbl = range(maxChar + 1, min((maxChar + 1) << shiftTable.pop(), maxChar + 1 + MAX_INT))
                                originalTbl = range(charTbl[0], charTbl[-1] + 1)
                                maxChar = maxValue = charTbl[-1]
                                minValue = charTbl[0]
                            else:
