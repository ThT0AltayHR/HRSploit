"""
SQLite Database Dump Module - Dosya 46
...
logger = logging.getLogger('SQLiteDumper')
...
class SQLiteImplementation(SQLiteDumper):
...
class SQLiteDumpManager:
    ...
    def create_dump(self, config: DumpConfig) -> str:
        """Create new dump"""
        with self.lock:
            dumper = SQLiteImplementation(config)
