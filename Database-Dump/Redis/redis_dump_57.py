"""
Redis Database Dump Module - Dosya 57
...
logger = logging.getLogger('RedisDumper')
...
class RedisImplementation(RedisDumper):
...
class RedisDumpManager:
    ...
    def create_dump(self, config: DumpConfig) -> str:
        """Create new dump"""
        with self.lock:
            dumper = RedisImplementation(config)
