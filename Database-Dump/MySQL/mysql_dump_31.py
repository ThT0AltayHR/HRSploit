"""
MySQL Database Dump Module - Dosya 31
...
class MySQLImplementation(MySQLDumper):
...
class MySQLDumpManager:
    ...
    def create_dump(self, config: DumpConfig) -> str:
        """Create new dump"""
        with self.lock:
            dumper = MySQLImplementation(config)
